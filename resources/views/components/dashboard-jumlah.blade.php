<div
    class="grid grid-cols-3 gap-3 ml-96 mt-10 mr-10">
    <div
    	...
    	<div
    		...
    		<img 
                ...
                class="w-20 mr-5">
            <p
                class="text-5xl text-gray-500 font-semibold">24</p>
    	</div>
    	<p
    ...
    <div
    	...
    	<div
    		...
    		<img 
                ...
                class="w-20 mr-5">
            <p
                 class="text-5xl text-gray-500 font-semibold">3</p>
    	</div>
    	<p
    ...
    <div
    	...
    	<div
    		...
    		<img 
                ...
                class="w-20 mr-5">
            <p
                 class="text-5xl text-gray-500 font-semibold">150</p>
    	</div>
            <p
